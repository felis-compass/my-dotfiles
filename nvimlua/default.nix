  ...
  categoryDefinitions =
    { pkgs, settings, categories, extra, name, mkNvimPlugin, ... }@packageDef: {
      ...
      startupPlugins = with pkgs.vimPlugins; {
        ...
        custom-ai = [ codecompanion-nvim ];
        custom-ai-nonfree = [ windsurf-nvim ];
        require-mason = [
          mason-nvim
      ...
      environmentVariables = { 
        ...
        general = {
          VSCODE_JAVA_DEBUG_PATH = "${pkgs.vscode-extensions.vscjava.vscode-java-debug}";
          VSCODE_JAVA_TEST_PATH = "${pkgs.vscode-extensions.vscjava.vscode-java-test}";
        };
      };
